                    ...
                    <div class="collapse navbar-collapse navbar-toggler-collapse rounded-bottom"
                        ...
                        <ul class="navbar-nav">
                                    ...
                                    @if (in_array(Auth::guard('dosen')->user()->role_id, [6, 7, 8]))
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('mbkm*') ? 'text-success' : '' }} "
                                                aria-current="page" href="/mbkm/prodi">MBKM</a>
                                        </li>
                                    @endif
                                @endif
                                @if (Auth::guard('dosen')->check())
                                    @if (in_array(Auth::guard('dosen')->user()->role_id, [5, 6, 7, 8]))
                                        <li class="nav-item dropdown baru">
                                            <a id="dropdownSubMenu3" href="#" data-toggle="dropdown"
                                                ...
                                                class="nav-link dropdown-toggle">MATA KULIAH</a>
                                            <ul aria-labelledby="dropdownSubMenu3"
                                                class="dropdown-menu border-0 shadow" style="border-radius: 10px;">
                                                <li><a href="/absensi"
                                                        class="dropdown-item mb-1 nav-link {{ Request::is('absensi') ? 'text-success' : '' }} {{ Request::is('absensi/riwayat-absensi') ? 'text-success' : '' }} {{ Request::is('absensi/ruangan-absensi') ? 'text-success' : '' }} ">Absensi</a>
                                                </li>
                                                @if (Auth::guard('dosen')->check() && in_array(Auth::guard('dosen')->user()->role_id, [5, 6, 7, 8]))
                                                    <li><a href="/matakuliah"
                                                            class="dropdown-item mb-1 nav-link {{ Request::is('matakuliah') ? 'text-success' : '' }} {{ Request::is('matakuliah/riwayat') ? 'text-success' : '' }} ">Pengelola</a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </li>
                                    @else
                                        <li><a href="/absensi"
                                                class="nav-link  {{ Request::is('absensi') ? 'text-success' : '' }} {{ Request::is('absensi/riwayat-absensi') ? 'text-success' : '' }} {{ Request::is('daftar-perkuliahan/*') ? 'text-success' : '' }} {{ Request::is('absensi/ruangan-absensi*') ? 'text-success' : '' }} ">ABSENSI</a>
                                        </li>
                                    @endif
                                @endif
                            ...
                            @if (Str::length(Auth::guard('web')->user()) > 0)
                                ...
                                @endif
                                @if (Auth::guard('dosen')->check())
                                    @if (in_array(Auth::guard('dosen')->user()->role_id, [2, 3, 4]))
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::is('mbkm*') ? 'text-success' : '' }} "
                                                aria-current="page" href="/mbkm/staff">MBKM</a>
                                        </li>
                                    @endif
                                @endif
                            @endif
                            ...
                            @if (Str::length(Auth::guard('mahasiswa')->user()) > 0)
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('mbkm*') ? 'text-success' : '' }} "
                                        aria-current="page" href="/mbkm/mahasiswa">MBKM</a>
                                </li>
                            @endif
                    ...
                    @if (Auth::guard('web')->check() && in_array(Auth::guard('web')->user()->role_id, [1]))
                        <li class="nav-item dropdown baru">
                            <a id="dropdownSubMenu3" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false" class="nav-link dropdown-toggle">ABSENSI</a>
                            <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow"
                                style="border-radius: 10px;">
                                <li><a class="dropdown-item mb-1 nav-link {{ Request::is('matakuliah') ? 'text-success' : '' }} {{ Request::is('matakuliah/create') ? 'text-success' : '' }} {{ Request::is('matakuliah/riwayat') ? 'text-success' : '' }}"
                                        href="/matakuliah">Mata Kuliah</a></li>
                                ...
                                <li><a class="dropdown-item mb-1 nav-link {{ Request::is('gedung') ? 'text-success' : '' }} "
                                        href="/gedung">Gedung</a></li>
                            </ul>
                        </li>
